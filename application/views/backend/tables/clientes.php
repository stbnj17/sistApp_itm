        ...
        <div class="right_col" role="main">
          <div class="">
            ...
            if (in_array(5, $arrRoles)): ?>
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Nuevo Cliente <small>Cree un nuevo cliente (Empresa o Persona Natural).</small></h2>
            ...
            <?php if (in_array(8, $arrRoles) || $actions != ''): ?>
            <div id="secListas" class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Listas de Clientes |<small>Muestra relación de Clientes según el Tipo de Cliente.</small></h2>
                    <div class="clearfix"></div>
                  </div>
                  <div class="x_content">
                    <div class="" role="tabpanel" data-example-id="togglable-tabs">
                      ...
                      <div id="myTabListContent" class="tab-content">
                        <div role="tabpanel" class="tab-pane fade active in" id="tabList_empresa" aria-labelledby="empresa-tabList">
                          <p class="text-muted font-13 m-b-30">
                            Este apartado lista los Clientes de tipo Empresa.
                          </p>
                        ...
                        <div role="tabpanel" class="tab-pane fade" id="tabList_persona" aria-labelledby="persona-tabList">
                          <p class="text-muted font-13 m-b-30">
                            Este apartado lista los Clientes de tipo Persona Natural.
                          </p>
